...
var ImageParticles = {
    ...
    initialize: 
	function(canvas_id, imageData,densityPara=6,produceDistancePara=0,baseRadiusPara=2,maxLineThicknessPara=10,reactionSensitivityPara=12,
	lineThicknessPara=7) {
    ...
    produceparticles: function() {
        ...
        for (i = 0; i < this.particles.length; i++) {
            ...
            this.context.beginPath();
            this.context.arc(currentPoint.x, currentPoint.y, this.baseRadius, 40, Math.PI * 2, true);
